...
const Donate = () => (
  <div id="donate" className="text-center text-sm rounded-lg my-12 p-4">
    ...
    <form className="m-auto" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
      ...
      <input type="image" src="https://github.com/themarquisdesheric/amber-health/blob/master/static/img/donate-button.png?raw=true" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
